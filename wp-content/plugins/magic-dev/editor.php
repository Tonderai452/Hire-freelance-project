...
<body class="<?php echo $classesReturn; ?>">
	...
	<div id="responsive-size-text"><a href="http://wilbertz.co.za/yellow-pencil/documentation/#responsive-tool" target="_blank" class="support-icon" data-toggle='tooltip' data-placement='right' title='Click here to take a look at Responsive Tool docs.'>?</a> Customizing for <span class="device-size"></span>px and <span class="media-control" data-code="max-width">below</span> screen sizes. <span class="device-name"></span></div>

	<?php yp_yellow_penci_bar(); ?>
	
	<div class="top-area-btn-group">
		<a target="blank" class="yellow-pencil-logo" href="http://wilbertz.co.za/yellow-pencil"></a>
	...
	<div class="yp-info-modal">
		...
		<div class="yp-info-modal-top-inner">
			<h2><?php _e("Changes not saved.","yp"); ?></h2>
			<p><?php _e("You have used some premium properties. Get premium or disable premium properties to save changes.","yp"); ?></p>
		</div>
		<ul>
			<li><?php _e("600+ Font families","yp"); ?></li>
			<li><?php _e("50+ CSS Animations","yp"); ?></li>
			<li><?php _e("300+ Background patterns","yp"); ?></li>
			<li><?php _e("Gradient Generator","yp"); ?></li>
			<li><?php _e("Modern Color palettes","yp"); ?></li>
		...
		<div class="yp-action-area">
			...
			<a class="yp-buy-link" target="_blank" href="http://wilbertz.co.za/yellow-pencil/buy"><?php _e("Get Premium","yp"); ?></a>
