...
function yp_welcome_screen_content(){
  ...
  <div class="wrap yp-page-welcome about-wrap">
	<h1>Welcome to Magic Dev <?php echo YP_VERSION; ?></h1>

	<div class="about-text">
		Congratulations! You are about to use most powerful design tool for WordPress ever - Magic Dev Style Editor Plugin by Wilbertz.</div>
	<div class="wp-badge yp-badge">Version <?php echo YP_VERSION; ?></div>
	<p>
		<a href="<?php echo admin_url('themes.php?page=yellow-pencil'); ?>" class="button button-primary button-large devt" >let's start!</a>
	</p>
	...
	<div class="yp-welcome-tab">
		...
		<div class="yp-right-content">
			...
			<p>Magic Dev is advanced visual CSS style editor wordpress plugin that you can customize your website in real-time with a few clicks. Magic Dev works with any theme and plugin.</p>

			<p>Today become a professional web designer and personalizing your website in a few mins!</p>

			<h3>What's New?</h3>
			Take a look to <a href="http://wilbertz.co.za/yellow-pencil/release-notes/" target="_blank">Release Notes</a> for see all details about new updates.
		</div>
		<div class="clear"></div>
	...
	<div class="yp-welcome-tab">
		...
		<div class="yp-resources-left">
			...
			<p></p>
			<ul>
				<li><a href="http://wilbertz.co.za/yellow-pencil/release-notes/" target="_blank">Release Notes</a></li>
				<li><a href="http://wilbertz.co.za/yellow-pencil/documentation/" target="_blank">Documentation</a></li>
				<li><a href="http://wilbertz.co.za/yellow-pencil/" target="_blank">Plugin Website</a></li>
				<li><a href="https://wilbertz.ticksy.com/" target="_blank">Official support</a></li>
			</ul>

			<h3>Follow Us</h3>
			<ul>
				<li><a href="https://twitter.com/@wilbertz" target="_blank">Twitter</a></li>
				<li><a href="https://www.facebook.com/wilbertz/" target="_blank">Facebook</a></li>
				<li><a href="https://codecanyon.net/user/wilbertz" target="_blank">Envato</a></li>
			</ul>
		</div>
		...
		<div class="yp-resources-right">
			...
			<ul>
				...
				<li><a href="http://codecanyon.net/item/yellow-pencil-visual-customizer-for-wordpress/11322180?ref=Wilbertz" target="_blank">Get Pro Version</a></li>
			</ul>
	...
	<div class="yp-welcome-feature feature-section">
		...
		<div class="yp-column">
			...
			<div class="yp-feature-column">
				<h4>Help & Support!</h4>
				<p>You must read all plugin documentation for learn how this works, Only 3 mins to read! <a target="_blank" href="http://wilbertz.co.za/yellow-pencil/documentation/">plugin docs</a>.</p>
			</div>
	...
	<p class="yp-thank-you">Thank you for choosing Magic Dev,<br>Made By Wilbertz.</p>
	<?php } ?>
...
function yp_admin_footer () {
	...
	if($is_yellow_pencil_screen){
		...
		if(defined('WTFV')){
			echo 'Enjoyed <strong>Magic Dev</strong>? Please leave us a <a target="_blank" href="https://codecanyon.net/downloads">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. We really appreciate your support!';
		}else{
			echo 'Enjoyed <strong>Magic Dev</strong>? Please leave us a <a target="_blank" href="https://wordpress.org/support/plugin/yellow-pencil-visual-theme-customizer/reviews/?filter=5#new-post">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. We really appreciate your support!';
		}
...
function yp_option_func() {
		...
		$active_tab = str_replace("magic-dev_page_", "", $active_tab);
            ...
            <?php
				...
				/* ---------------------------------------------------- */
                	...
                	if(isset($_GET['purchase_code']) || $purchase_code){
                		$isActive = true;
                		$activate_btn = 'Magic Dev Activated';
                		...
                		$activate_btn = 'Activate Magic Dev Pro';
                		$aclink = '<a class="button button-primary button-hero yp-product-activation" href="http://wilbertz.co.za/yellow-pencil/auto-update/?client-redirect='.urlencode(admin_url('admin.php?page=yellow-pencil-license')).'">';
                	}

                	// Thank you.
                	if(isset($_GET['purchase_code']) && defined("WTFV") == TRUE){
                		echo '<div class="updated"><p><strong>Magic Dev Pro successfully activated.</strong></p></div>';
                	}

                	// no license founded
                	if(isset($_GET['activation_error'])){
                		echo '<div class="error"><p><strong>No licenses found on your Envato account, <a href="http://wilbertz.co.za/yellow-pencil/buy/" target="_blank">Get your copy today</a>.</strong></p></div>';
                	}


                	?>

                	<div class="yp-activation-section <?php if(!defined('WTFV')){ echo 'yp-go-pro'; } ?>">

                		<?php if($isActive == false){ ?>

                			<?php if(defined('WTFV')){ ?>

	                			<p>In order to receive all benefits of Magic Dev, you need to activate your copy of the plugin. By activating Magic Dev License you will unlock <strong>premium features</strong> and <strong>direct plugin updates</strong>.</p>

	                		<?php }else{ ?>

	                			<h1>Unlock Premium Features!</h1>
	                			<p>Would you like to access all premium features? <strong>Font families</strong>, <strong>Backgrounds</strong>, <strong>Animations</strong> and much more. Upgrade Magic Dev Pro today! First, buy a license and then activate it.</strong></p>

	                		<?php } ?>

	                	<?php }else{ ?>
	                		<p>You have activated Magic Dev Pro version which allows you to access all the customer benefits! You will be notified when new updates are available. Thank you for choosing Magic Dev!</p>
	                	<?php } ?>
	                    ...
	                    <p style="margin:0px;padding:0px;">
	                    	...
	                    	<?php if(defined('WTFV') == false && isset($_GET['purchase_code']) == false){ ?>
	                    	<a target="_blank" class="button button-hero" href="http://wilbertz.co.za/yellow-pencil/buy/" style="margin-right:20px;position:relative;top:1px;">Buy license</a>
	                    	<?php } ?>

	                    	<?php echo $aclink; ?><?php echo $activate_btn; ?></a><?php echo $loadingIcon; ?>

	                    </p>

	                    <?php if($extraClassBtn != ''){ ?>
	                    	<p class='description'>Magic Dev Pro installing. This may take a few minutes. Please don't close the page!</p>
	                    <?php } ?>

	                    <?php if($isActive == false){ ?>

	                    	<?php if(!defined('WTFV')){ ?>
	                    		<p class='description'>Check out <a href='http://wilbertz.co.za/yellow-pencil/' target='_blank'>the plugin website</a> for getting more information.</p>
	                    	<?php }else{ ?>
		                    	<p class='description'>Don't have license yet? <a href='http://wilbertz.co.za/yellow-pencil/buy/' target='_blank'>Purchase Magic Dev license</a>.</p>
							<?php } ?>
						<?php } ?>
