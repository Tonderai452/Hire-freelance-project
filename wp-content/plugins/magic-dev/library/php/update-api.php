...
function yp_getting_ver_from_changelog(){
    ...
    // Changelog URL
    $url = "http://www.wilbertz.co.za/yellow-pencil/inc/changelog.txt";
    ...
    if(defined('WTFV') == true){
        ...
        if($isUpdate != 'true' && current_user_can("update_plugins") == true && YP_PURCHASE_CODE == '' && strstr($base,"yellow-pencil") == false){
           ...
           <!--  <div class="update-nag yp-update-info-bar">
                <php _e("Hola! Would you like to receive automatic updates? Please <a style='box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;' href='".admin_url('admin.php?page=yellow-pencil-license')."'>activate your copy</a> of Magic Dev.","yp"); ?>
            </div> -->
        <?php
        }
        ...
        if($isUpdate == 'true' && $lastCheckVer == YP_FORMATTED_VERSION && $available > YP_FORMATTED_VERSION && current_user_can("update_plugins") == true && YP_PURCHASE_CODE != ''){
            ...
            ?>
            <div class="update-nag yp-update-info-bar">
                <a target="_blank" href="http://wilbertz.co.za/yellow-pencil/release-notes">Magic Dev <?php echo $versionView; ?></a> <?php _e("is available!","yp"); ?> <a style="box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;" href="#" class="yp_update_link"><?php _e("Please update now","yp"); ?>.</a>
            </div>
            <?php
            ...
            ?>
            <div class="update-nag yp-update-info-bar">
                <?php _e("New updates are available for Magic Dev! Please activate your copy to receive automatic updates.","yp"); ?> <a style="box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;" href="<?php echo admin_url('admin.php?page=yellow-pencil-license'); ?>"><?php _e("Activate now!","yp"); ?></a>
            </div>
            <?php
