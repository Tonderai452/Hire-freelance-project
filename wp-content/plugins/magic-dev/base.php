...
function yp_get_slider_markup($cssName, $name, $default = 'inherit', $decimals, $pxv, $pcv, $emv,$note = null){
    ...
    if(!defined("WTFV")){
	    if($cssName == 'opacity'){
	    	$notice_last = "<p class='yp-alert-warning yp-notice-last'>".ucfirst(strtolower($name))." ".__('property not available for lite version.','yp')." <a target='_blank' href='http://wilbertz.co.za/yellow-pencil/buy'>".__('Go Pro','yp')."?</a></p>";
	    }
    }
