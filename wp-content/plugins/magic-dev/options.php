...
echo "<ul class='yp-editor-list'>
		...
		<li class='animation-option'>
			...
			<div class='yp-this-content'>
				...
				<p class='yp-alert-warning yp-top-alert yp-lite'>Animation ".__('property not available for lite version.','yp')." <a target='_blank' href='http://wilbertz.co.za/yellow-pencil/buy'>".__('Go Pro','yp')."?</a></p>
		...
		<li class='yp-li-footer'>
			<h3><a target='_blank' href='http://wilbertz.co.za/yellow-pencil/documentation/'>".__('Documentation','yp')."</a> / V ".YP_VERSION."</h3>
		</li>
