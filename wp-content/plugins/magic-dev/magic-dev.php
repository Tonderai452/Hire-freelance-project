<?php
/*
Plugin Name: Wilbertz: Magic Dev Pro
Plugin URI: http://wilbertz.co.za/
...
Version: 10
Author: Wilbertz
Author URI: http://www.wilbertz.co.za
*/
...
if (strstr(__FILE__, "yellow-pencil-visual-theme-customizer")) {
    $lite_dir       = __FILE__;
    $currentVersion = 'lite';
    $pro_dir        = str_replace("yellow-pencil-visual-theme-customizer", "magic-dev", __FILE__);
} else {
    $pro_dir        = __FILE__;
    $currentVersion = 'pro';
    $lite_dir       = str_replace("magic-dev", "yellow-pencil-visual-theme-customizer", __FILE__);
}
...
// Upgrade to Pro: activation.
if(!defined('WTFV')){
    include(WT_PLUGIN_DIR . 'library/php/upgrade-api.php');
}
...
function yp_customize_link($links, $file) {
    ...
    if ($file == plugin_basename(dirname(__FILE__) . '/magic-dev.php')) {
        $in = '<a style="color:rgb(64, 113, 64);font-weight:600;" href="' . admin_url('themes.php?page=magic-dev') . '">' . __('Do Magic', 'yp') . '</a>';
...
/* ---------------------------------------------------- */
function yp_menu() {
    add_theme_page('Magic Dev Editor', 'Magic Dev Editor', 'edit_theme_options', 'magic-dev', 'yp_menu_function', 999);
}
...
function yp_get_css($r = false) {
    ...
    if ($onlyCSS != '' && $r == false) {
        ...
        $return .= "\r\n/*\r\n\tThe following CSS generated by Magic Dev Plugin.\r\n\thttp://wilbertz.co.za/yellow-pencil\r\n*/\r\n";
...
function yp_yellow_pencil_edit_admin_bar($wp_admin_bar) {
    ...
    $args = array(
        'id' => 'yellow-pencil',
        'title' => __('Edit With Magic Dev', 'yp'),
        'href' => '',
        'meta' => array(
            'class' => 'yellow-pencil'
        )
...
function yp_yellow_pencil_editor() {
    ...
    $hook = add_submenu_page(null, __('Magic Dev Editor', 'yp'), __('Magic Dev Editor', 'yp'), 'edit_theme_options', 'yellow-pencil-editor', 'yp_editor_func');
...
if (!defined('WTFV')) {
    ...
    function yp_plugin_links($links, $file) {
        ...
        if ($file == plugin_basename(dirname(__FILE__) . '/yellow-pencil.php')) {
            $links[] = '<a href="http://wilbertz.co.za/yellow-pencil/buy">' . __('Get Premium', 'yp') . '</a>';
        }
...
function yp_get_export_css($method) {
    ...
    if (empty($allData) == false) {
        ...
        // All in.
        $allOutPut = "/*\r\n\r\n    These CSS codes generated by Magic Dev Editor.\r\n";
        $allOutPut .= "    http://wilbertz.co.za/yellow-pencil\r\n\r\n\r\n";
