...
Easily create the lightbox with any type of information you want to show for your visitors. You can simply choose the most appropriate popup type and template that fit to the design of your website and make popup in the shortest time. Add the shortcode to any post, where you want to show popup. It is possible to make unlimited number of popups with unique configurations. 
...
According to your needs, show popup only for first time users, or for everybody. It can be loaded automatically with time delay or by clicking on some place of the page. There many options helping to adapt the popup to the individual needs.
