<?php
// Template Name: Manage Freelance Portfolio
/**
...
if(is_user_logged_in())
{
	...
	$new_post = array(
		...
		'field_groups'       => array( 'group_56fe5821d058e66' ), // Create post field group ID(s)
		'form'               => true,
		...
		<div class="uk-container uk-container-center">
			<div class="uk-grid">
				<div class="uk-width-1-1">
					...
					<a href="<?php echo site_url();?>/dashboard/" class="uk-button uk-button-blue uk-button-small" >Back To Dashboard</a>
