...
<h4 class="sdWooHeading"><?php echo $page_title; ?></h4>
...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address">
		<header class="title">
			<div class="clearfix">&nbsp;</div>
			<h4 class="sdWooHeading"><?php echo $title; ?></h4>
			<a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit btn btn-sm btn-default"><?php _e( 'Edit', 'woocommerce' ); ?></a>
		</header>
		<address>
			<?php
