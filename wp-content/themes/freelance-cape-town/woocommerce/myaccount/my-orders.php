...
if ( $customer_orders ) : ?>
	...
	<h4 class="sdWooHeading"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></h4>
	<div class="clearfix">&nbsp;</div>

	<table class="shop_table shop_table_responsive my_account_orders" id="sdWooCommerceAccountOrderTable">
